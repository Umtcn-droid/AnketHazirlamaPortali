...
@Component({
  selector: 'app-tekanketjoin',
  templateUrl: './tekanketjoin.component.html',
  styleUrls: ['./tekanketjoin.component.css']
})
export class TekanketjoinComponent implements OnInit,OnDestroy {
 ...
 console.log("1.adım çalısıyor");
    ...
    if(this.surveys!=undefined){
      console.log("2.adım ifin içindeyim");
        ...
        if(this.selectedSurvey != undefined){
          console.log("3.adım içiçe iflerdeyim");
